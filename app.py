...
TEAMS = {
    "Tim A": {
        "Ketua Tim": ["Kandidat 1", "Kandidat 2", "Kandidat 3"],
        "Pelatih": ["Pelatih 1", "Pelatih 2"]
    },
    "Tim B": {
        "Ketua Tim": ["Kandidat A", "Kandidat B"],
        "Pelatih": ["Pelatih X", "Pelatih Y", "Pelatih Z"]
    },
    "Tim C": {
        "Ketua Tim": ["Ketua 1", "Ketua 2"],
        "Pelatih": ["Pelatih Alpha", "Pelatih Beta"]
    },
    "Tim D": {
        "Ketua Tim": ["Ketua D1", "Ketua D2"],
        "Pelatih": ["Pelatih Delta1", "Pelatih Delta2"]
    },
    "Tim E": {
        "Ketua Tim": ["Ketua E1", "Ketua E2"],
        "Pelatih": ["Pelatih E1", "Pelatih E2", "Pelatih E3"]
    }
}
